...
public class EmployeeEditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (employeeIdStr != null) {
            try {
                ...
                EmployeeSearchDTO employee = EmployeeSearchDAO.getEmployeeById(employeeId); // staticメソッドを使用
                ...
                if (employee != null) {
                    ...
                    RequestDispatcher dispatcher = request.getRequestDispatcher("/mainJsp/employeeEdit.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            boolean isUpdated = EmployeeSearchDAO.updateEmployee(employee); // staticメソッドを使用

            if (isUpdated) {
                // 更新が成功した場合、検索結果ページにリダイレクト
                response.sendRedirect("EmployeeSearchResultServlet");
            } else {
                // 更新失敗の場合
